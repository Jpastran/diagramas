...
function figure_TriangleInvet(x,y)
{
    ...
    var t2 = new Text(FigureDefaults.textStr, x + FigureDefaults.segmentSize/2 - 2, y + FigureDefaults.segmentSize/3, FigureDefaults.textFont, FigureDefaults.textSize);
    t2.style.fillStyle = FigureDefaults.textColor;
...
{
    var c = new Arc(x + 20, y, FigureDefaults.radiusSize, 270, 450, false, 0);
    var p = new Polyline();
    p.addPoint(new Point(x + 20, y - FigureDefaults.radiusSize));  
    ...
    var t2 = new Text(FigureDefaults.textStr, x + FigureDefaults.radiusSize/2, y, FigureDefaults.textFont, FigureDefaults.textSize);
    t2.style.fillStyle = FigureDefaults.textColor;
...
{
	var p = new Polyline();	
    p.addPoint(new Point(x, y + 15));  
    p.addPoint(new Point(x, y + 45));
    p.addPoint(new Point(x + 50 , y + 45));
    p.addPoint(new Point(x + 50 , y + 60));
    p.addPoint(new Point(x + 80, y + 30));  
    p.addPoint(new Point(x + 50, y));
    p.addPoint(new Point(x + 50 , y + 15));
    p.addPoint(new Point(x, y + 15));
    ...
    var t2 = new Text(FigureDefaults.textStr, x + 30, y + 30, FigureDefaults.textFont, FigureDefaults.textSize);
    t2.style.fillStyle = FigureDefaults.textColor;
    
    f.addPrimitive(t2);
    
    CONNECTOR_MANAGER.connectionPointCreate(f.id, new Point(x + 40, y + 15), ConnectionPoint.TYPE_FIGURE);
    CONNECTOR_MANAGER.connectionPointCreate(f.id, new Point(x + 40, y + 45), ConnectionPoint.TYPE_FIGURE);
